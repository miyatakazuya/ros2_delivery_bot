...
class OakPerceptionNode(Node):
    def __init__(self):
        ...
        self.get_logger().info('--- OAK Perception Node (Hardware Master) Started ---')
        ...
        if in_rgb is not None:
            ...
            if self.yolo_active and in_nn is not None:
                ...
                for det in detections:
                    ...
                    # Only draw if we are going to show it or publish debug
